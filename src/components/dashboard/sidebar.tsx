...
export function DashboardSidebar({ className, children }: DashboardSidebarGenericProps) {
 return (
  <aside className={cn(["border-r border-border flex flex-col space-y-6 w-fit", className])}>
   {children}
  </aside>
 );
}
...
export function DashboardSidebarNavHeaderTitle({ className, children }: DashboardSidebarGenericProps) {
 return (
  <h4 className={cn(["text-xs ml-3 uppercase text-muted-foreground pointer-events-none", className])}>{children}</h4>
 );
}
...
export function DashboardSidebarFooter({ className, children }: DashboardSidebarGenericProps) {
 return (
  <footer className={cn(["p-6 mt-auto border-t border-border", className])}>{children}</footer>
 );
}
